...
export enum OscarEnum {
  ...
  OSCAR_BEST_SOUND_EDITING = 'OSCAR_BEST_SOUND_EDITING',
...
export const OSCAR_ENUM_OPTIONS: readonly OscarEnum[] = [
  ...
  OscarEnum.OSCAR_BEST_SOUND_EDITING,
...
export const OSCAR_LABELS: Record<OscarEnum, string> = {
  ...
  [OscarEnum.OSCAR_BEST_SOUND]: 'Meilleur mixage de son',
  [OscarEnum.OSCAR_BEST_SOUND_EDITING]: 'Meilleur montage de son',
