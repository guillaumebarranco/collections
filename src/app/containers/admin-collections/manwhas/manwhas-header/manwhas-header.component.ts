...
@Component({
  selector: 'app-admin-manwhas-header',
...
export class AdminManwhasHeaderComponent {
  ...
  openAddManwhaAdminDialog(): void {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      if (result?.created) this.router.navigate(['/admin/manwhas']);
    });
  }
}
