...
export const ronanBooks: UserBook[] = [
  ...
  {
    title: 'Le Retour du roi (Le Seigneur des Anneaux, #3)',
    author: 'J.R.R. Tolkien',
    rating: 4,
    readDate: '',
    readTimes: 1,
  ...
  {
    title: 'Les Deux Tours (Le Seigneur des Anneaux, #2)',
    author: 'J.R.R. Tolkien',
    rating: 4,
    readDate: '',
    readTimes: 1,
  ...
  {
    title: 'La Dame du lac (Sorceleur #7)',
  ...
  {
    title: 'The Tower of the Swallow (The Witcher, #4)',
    author: 'Andrzej Sapkowski',
    rating: 3,
    readDate: '',
    readTimes: 1,
  ...
  {
    title: 'Das Erbe der Macht (Eragon, #4)',
  ...
  {
    title: 'Die Weisheit des Feuers (Eragon, #3)',
    author: 'Christopher Paolini',
    rating: 4,
    readDate: '',
    readTimes: 1,
  ...
  {
    title: 'Der Auftrag des Ältesten (Eragon, #2)',
    author: 'Christopher Paolini',
    rating: 4,
    readDate: '',
    readTimes: 1,
