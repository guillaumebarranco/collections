...
export const baseMoviesAnimated2Source: BaseMovie[] = [
  {
...
const isDisneyPixarMovie = (movie: BaseMovie): boolean =>
  movie.saga === 'Disney Classique' || movie.saga === 'Pixar';

export const baseMoviesAnimated2: BaseMovie[] =
  baseMoviesAnimated2Source.filter((movie) => !isDisneyPixarMovie(movie));
