...
export const baseMoviesJeunesse: BaseMovie[] = [
  ...
  },
  {
    ...
    genre: ['Aventure'],
    saga: 'Disney Live Action',
    description: 'Mowgli, enfant élevé par les loups dans la jungle indienne, doit affronter le tigre Shere Khan et choisir entre sa famille animale et le monde des hommes.',
    fromEntity: {
      entityType: 'book',
      title: "Le Livre de la jungle",
  ...
  },
  {
    ...
    saga: 'Disney Live Action',
    description: 'Un bébé éléphant aux oreilles démesurées rejoint un cirque en difficulté où une mère et ses enfants l\'aident à transformer sa différence en prodige volant.',
    fromEntity: {
      entityType: 'book',
      title: "Dumbo",
  ...
  },
  {
    ...
    genre: ['Aventure', 'Jeunesse'],
    saga: 'Disney Live Action',
    description: 'Ce prequel explore la jeunesse de Mufasa, de son origine inconnue à sa rencontre avec Taka, futur Scar, jusqu\'à son ascension au royaume des lions.',
    fromEntity: null,
    countryOrigin: ['États-Unis'],
    selectDisplayOrder: 20,
    oscars: [],
  ...
  },
  {
    ...
    genre: ['Fantastique', 'Romance'],
    saga: '',
    description: 'Belle, passionnée de livres, échange sa liberté contre celle de son père prisonnier d\'une Bête dans un château enchanté où objets magiques et amour s\'éveillent.',
    fromEntity: {
      entityType: 'book',
      title: "La Belle et la Bête",
  ...
  },
  {
    ...
    saga: '',
    description: 'Ariel, princesse des mers, rêve de rejoindre le monde des humains et fait un pacte avec une sorcière qui menace son royaume sous-marin et son amour pour Eric.',
    fromEntity: {
      entityType: 'book',
      title: "La Petite Sirène",
