...
export const baseSeries: BaseSerie[] = [
...

  {
    ...
    coverUrl: '/series_pictures/cc9d1b7978f9.jpg',
    releaseDate: '2022-07-14',
    endDate: '2022-07-14',
    genre: ['Action', 'Horreur', 'Science Fiction'],
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 8, totalLength: 360 }],
    description: '',
    fromEntity: {
      entityType: 'game',
      title: 'Resident Evil',
  ...
  },
  {
    ...
    coverUrl: '/series_pictures/3d237616a23b.jpg',
    releaseDate: '2010-07-25',
    endDate: '2017-01-15',
    genre: ['Policier', 'Drame'],
    seasonsData: [
      { seasonNumber: 1, nbEpisodes: 3, totalLength: 270 },
      { seasonNumber: 2, nbEpisodes: 3, totalLength: 270 },
      { seasonNumber: 3, nbEpisodes: 3, totalLength: 270 },
      { seasonNumber: 4, nbEpisodes: 3, totalLength: 270 },
    ],
    description: '',
    fromEntity: {
      entityType: 'book',
  ...
  },
  {
    ...
    coverUrl: '/series_pictures/6322855a15b2.jpg',
    releaseDate: '2012-09-27',
    endDate: '2019-08-15',
    genre: ['Policier', 'Drame'],
    seasonsData: [
      { seasonNumber: 1, nbEpisodes: 24, totalLength: 1056 },
      { seasonNumber: 2, nbEpisodes: 24, totalLength: 1056 },
      { seasonNumber: 3, nbEpisodes: 24, totalLength: 1056 },
      { seasonNumber: 4, nbEpisodes: 24, totalLength: 1056 },
      { seasonNumber: 5, nbEpisodes: 24, totalLength: 1056 },
      { seasonNumber: 6, nbEpisodes: 21, totalLength: 924 },
      { seasonNumber: 7, nbEpisodes: 13, totalLength: 572 },
    ],
    description: '',
    fromEntity: {
      entityType: 'book',
  ...
  },
  {
    ...
    coverUrl: '/series_pictures/6f3cc2fe88e6.jpg',
...

  {
    ...
    coverUrl: '/series_pictures/b2509108f201.jpg',
  ...
  },
  {
    ...
    coverUrl: '/series_pictures/b92423cddf87.jpg',
  ...
  },
  {
    ...
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 4, totalLength: 360 }],
    description: '',
    saga: 'Les Misérables',
    fromEntity: {
      entityType: 'book',
  ...
  },
  {
    ...
    endDate: '2019-02-03',
    genre: ['Drame', 'Historique'],
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 6, totalLength: 360 }],
    description: '',
    saga: 'Les Misérables',
    fromEntity: {
      entityType: 'book',
  ...
  },
  {
    ...
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 4, totalLength: 400 }],
    description: '',
  ...
  },
  {
    ...
    endDate: '1991-12-31',
    genre: ['Fantasy', 'Adventure'],
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 2, totalLength: 220 }],
    description: '',
    saga: 'Tolkien',
    fromEntity: {
      entityType: 'book',
  ...
  },
  {
    ...
    genre: ['Science Fiction', 'Thriller'],
    seasonsData: [
      { seasonNumber: 1, nbEpisodes: 23, totalLength: 1035 },
      { seasonNumber: 2, nbEpisodes: 21, totalLength: 945 },
    ],
    description: '',
...

  {
    ...
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 8, totalLength: 400 }],
    description: '',
    fromEntity: {
  ...
  {
    title: 'Sherlock Holmes (Granada, 1984)',
    director: 'John Hawkesworth, David Carson',
    actors: [
      { name: 'Jeremy Brett' },
      { name: 'David Burke' },
    ...
    genre: ['Policier', 'Mystère', 'Drame'],
    seasonsData: [
      { seasonNumber: 1, nbEpisodes: 13, totalLength: 650 },
      { seasonNumber: 2, nbEpisodes: 11, totalLength: 550 },
      { seasonNumber: 3, nbEpisodes: 9, totalLength: 450 },
  ...
  },
  {
    ...
    seasonsData: [{ seasonNumber: 1, nbEpisodes: 39, totalLength: 975 }],
    description: '',
    fromEntity: {
      entityType: 'book' as const,
      title: 'Les Aventures de Sherlock Holmes',
